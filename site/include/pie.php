            ...
            <div class="row">
                <div class="col-sm-7 text-left">
                   <h2>Vita</h2>
					...
					<p class="pr-5 text-white-50">Si es saludable, es Vita.</p>
				</div>
				<div class="col-lg-2 col-xs-6 location">
				  ...
				  <p><i class="fa fa-envelope-o mr-3"></i>soporte@vita.org</p>
				</div>
				 <div class="col-lg-2 col-xs-6 location">
				  <h4 class="mt-lg-0 mt-sm-2">Links</h4>
				  <a href="/home"><p  class="mb-0"style="color:white;font-size:15px;">Inicio</p></a>
