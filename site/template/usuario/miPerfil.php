    ...
    <div class="row">
		<div class="col-md-4 ">
            ...
            <div class="list-group list-group-flush" id="list-tab" role="tablist">
                <a class="list-group-item list-group-item-primary list-group-item-action active" id="list-home-list" data-toggle="list" href="#data" role="tab" aria-controls="mis-datos">Mis Datos</a>
                <a class="list-group-item list-group-item-primary list-group-item-action" id="list-profile-list" data-toggle="list" href="#password" role="tab" aria-controls="cambiar-contrasena">Cambiar Contraseña</a>
                <a class="list-group-item list-group-item-primary list-group-item-action" id="list-messages-list" data-toggle="list" href="#avatar" role="tab" aria-controls="avatar">Editar Avatar</a>
                <a class="list-group-item list-group-item-primary list-group-item-action" id="list-settings-list" data-toggle="list" href="#eliminar" role="tab" aria-controls="eliminar">Eliminar Cuenta</a>
            </div>
		    ...
		    <div class="card">
		        <div class="card-body">
                    ...
                    <div class="tab-content" id="nav-tabContent">
                        <div class="tab-pane fade active show" id="data" role="tabpanel" aria-labelledby="list-home-list">
